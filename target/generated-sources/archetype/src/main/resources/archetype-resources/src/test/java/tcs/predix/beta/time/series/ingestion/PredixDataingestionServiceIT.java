...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.tcs.predix.beta.time.series.ingestion;
...
import ${package}.ge.predix.solsvc.training.ingestion.Lo${package}otiveMonitoringBoot;
import ${package}.ge.predix.solsvc.training.ingestion.type.JSONData;


@RunWith(SpringJUnit4ClassRunner.class)
@SpringApplicationConfiguration(classes = Lo${package}otiveMonitoringBoot.class)
@WebAppConfiguration
