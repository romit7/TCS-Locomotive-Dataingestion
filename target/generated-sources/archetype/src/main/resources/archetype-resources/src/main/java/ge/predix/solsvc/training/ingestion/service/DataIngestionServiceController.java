...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.ge.predix.solsvc.training.ingestion.service;
...
import ${package}.ge.predix.solsvc.bootstrap.ams.dto.MeterDatasource;
import ${package}.ge.predix.solsvc.training.ingestion.api.DataIngestionServiceAPI;
import ${package}.ge.predix.solsvc.training.ingestion.handler.DataIngestionHandler;
        ...
        implements DataIngestionServiceAPI
{
	...
	public String ping() {
		return "SUCCESS"; //${symbol_dollar}NON-NLS-1${symbol_dollar}
	}
...
//    @RequestMapping(value = "/1mintemp/{asset_tag}", method = RequestMethod.GET)
//    public @ResponseBody String get1MinTemp(@PathVariable String asset_tag)
//    {
//    	
//    }
    @RequestMapping(value = "/retrieveasset/{asset_tag}", method = RequestMethod.GET)
    public @ResponseBody String getassetbytag(@PathVariable String asset_tag)
    {
        try
        {
            return this.dataIngestionHandler.retrieveAsset(asset_tag);
        }
        catch (Throwable e)
        {
            log.error("Failure in /retrieveasset GET ", e);
    ...
    @RequestMapping(value = "/retrieveassets", method = RequestMethod.GET)
    public @ResponseBody String getassetbytag()
    {
        try
        {
            return this.dataIngestionHandler.retrieveAsset(null);
        }
        catch (Throwable e)
        {
            log.error("Failure in /retrieveasset GET ", e);
